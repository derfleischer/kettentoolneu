...
# For get_chain_tool_properties utility function
def get_chain_tool_properties(context):
    """Get Chain Tool properties from context"""
    return context.scene.chain_tool_properties if hasattr(context.scene, 'chain_tool_properties') else None
